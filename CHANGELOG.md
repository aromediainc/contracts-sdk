...
- [#16](https://github.com/aromediainc/contracts-sdk/pull/16) [`c22a66f`](https://github.com/aromediainc/contracts-sdk/commit/c22a66f7ce8f4d57e181c097bcafb4b4f30015f0) Thanks [@zaghadon](https://github.com/zaghadon)! - Sync ABIs and addresses from `aromediainc/aromedia-blockchain-contracts@main`.

  Auto-generated by the `sync-abis` workflow on 2026-08-18.
...
- [#10](https://github.com/aromediainc/contracts-sdk/pull/10) [`a5bfb7c`](https://github.com/aromediainc/contracts-sdk/commit/a5bfb7ce6778cd0bd3dfccea6969c51924195144) Thanks [@github-actions](https://github.com/apps/github-actions)! - Sync ABIs and addresses from `aromediainc/aromedia-blockchain-contracts@main`.
...
- [#8](https://github.com/aromediainc/contracts-sdk/pull/8) [`a01f593`](https://github.com/aromediainc/contracts-sdk/commit/a01f5938a121909780145a83308bcfa8315756e7) Thanks [@github-actions](https://github.com/apps/github-actions)! - Sync ABIs and addresses from `aromediainc/aromedia-blockchain-contracts@main`.

  Auto-generated by the `sync-abis` workflow on 2026-06-04.
  Review the diff under `src/generated/` to confirm whether this should
  be bumped to a minor (additive) or major (breaking) release before merge.
...
- [#5](https://github.com/aromediainc/contracts-sdk/pull/5) [`7d64429`](https://github.com/aromediainc/contracts-sdk/commit/7d644292e39da2b9137403c069dd1b1941006a46) Thanks [@github-actions](https://github.com/apps/github-actions)! - Sync ABIs and addresses from `aromediainc/aromedia-blockchain-contracts@main`.
...
- [`e90c30a`](https://github.com/aromediainc/contracts-sdk/commit/e90c30ac86e395341665bc506cf925d3f8ea765d) Thanks [@zaghadon](https://github.com/zaghadon)! - fix(exports): point the `./abis` and `./addresses` subpath exports at `dist/generated/*`.
...
- [#3](https://github.com/aromediainc/contracts-sdk/pull/3) [`7fceb34`](https://github.com/aromediainc/contracts-sdk/commit/7fceb34146312e6523fe86054a6af6a793503ae4) Thanks [@github-actions](https://github.com/apps/github-actions)! - Sync ABIs and addresses from `aromediainc/aromedia-blockchain-contracts@main`.
